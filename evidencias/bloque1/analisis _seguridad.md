...
|------------------|--------------------|-----------|
| Administrador | Ajustes, Ventas, CRM, Facturación, Inventario, Compras |
Esperado |
| Comercial | CRM, Ventas, Clientes | Correcto |
| Contable | Facturación, Contabilidad | Correcto |
| Soporte | Soporte / módulos internos asignados | Revisar que no acceda a
Ajustes o Contabilidad |
### Observaciones
El acceso a módulos sensibles como Ajustes o Contabilidad debe estar
restringido. La presencia de módulos innecesarios visibles para perfiles
básicos se considera una mala práctica.
---
...
3. **Falta de segregación de funciones** entre áreas como ventas, soporte y
contabilidad.
...
---
## 8. Conclusión final
La configuración de seguridad del sistema presenta una base funcional, pero
requiere revisión para asegurar una asignación correcta de permisos y accesos.
